class AppStrings {
  ...
  String get printOptions => _t('printOptions');
  String get viewPdf => _t('viewPdf');
  String get bluetoothPrinter => _t('bluetoothPrinter');
  String get connectingBluetooth => _t('connectingBluetooth');
  String get noPairedBluetoothDevices => _t('noPairedBluetoothDevices');
  String get selectPrinterDevice => _t('selectPrinterDevice');
  String get bluetoothConnectFailed => _t('bluetoothConnectFailed');
  String get printingPleaseWait => _t('printingPleaseWait');
  String get printedSuccessfully => _t('printedSuccessfully');
  String get printFailed => _t('printFailed');
  String get noPdfViewerInstalled => _t('noPdfViewerInstalled');
  String get connectBluetoothPrinter => _t('connectBluetoothPrinter');
  String get printChallan => _t('printChallan');
  String get pleaseGrantBluetoothPermissions => _t('pleaseGrantBluetoothPermissions');
  String get pleaseTurnOnBluetooth => _t('pleaseTurnOnBluetooth');
  String get bluetoothPrinterConnected => _t('bluetoothPrinterConnected');
  String get connectPrinterFirst => _t('connectPrinterFirst');
  ...
  static const Map<String, Map<String, String>> _data = {
    'en': {
      ...
      'noCountersFound': 'No counters available',
      'noBoxesFound': 'No boxes available',
      'noBranchesFound': 'No branches available',
      'noExhibitionsFound': 'No exhibitions available',
      'counter': 'Counter',
      'branch': 'Branch',
      'search': 'Search',
      'order': 'Order',
      ...
      'configureCustomApi': 'Configure Custom API',
      'enterApiUrl': 'Enter API URL',
      'apiUrlAuthorizedMessage': 'Ensure the API URL belongs to an authorized RRGOLD server.',
      ...
      'connectingBluetooth': 'Connecting Bluetooth…',
      'noPairedBluetoothDevices': 'No paired Bluetooth devices found',
      'selectPrinterDevice': 'Select printer device',
      'bluetoothConnectFailed': 'Bluetooth printer connection failed',
      'printingPleaseWait': 'Printing… please wait',
      'printedSuccessfully': 'Printed successfully',
      'printFailed': 'Printing failed',
      'noPdfViewerInstalled': 'No PDF viewer app installed',
      'connectBluetoothPrinter': 'Connect Bluetooth Printer',
      'printChallan': 'Print Challan',
      'pleaseGrantBluetoothPermissions': 'Please grant Bluetooth permissions',
      'pleaseTurnOnBluetooth': 'Please turn on Bluetooth',
      'bluetoothPrinterConnected': 'Bluetooth printer connected',
      'connectPrinterFirst': 'Connect the Bluetooth printer first',
      'failedToSaveFaceToServer': 'Failed to save face info to server',
      'failedFieldsLabel': 'Failed: {fields}',
      'customApiUrlHint': 'http://192.168.6.9:8081',
      ...
      'syncedItemsCount': 'Synced {synced} / {total} items',
      'notSynced': 'Not Synced ({count}):',
      ...
      'selectFromError': 'Please select From location',
      'selectToError': 'Please select To location',
    ...
    'hi': {
      ...
      'noCountersFound': 'कोई काउंटर उपलब्ध नहीं है',
      'noBoxesFound': 'कोई बॉक्स उपलब्ध नहीं है',
      'noBranchesFound': 'कोई शाखा उपलब्ध नहीं है',
      'noExhibitionsFound': 'कोई प्रदर्शनी उपलब्ध नहीं है',
      'counter': 'काउंटर',
      'branch': 'शाखा',
      'search': 'खोज',
      'order': 'ऑर्डर',
      ...
      'configureCustomApi': 'कस्टम API कॉन्फ़िगर करें',
      'enterApiUrl': 'API URL दर्ज करें',
      'apiUrlAuthorizedMessage': 'सुनिश्चित करें कि API URL अधिकृत RRGOLD सर्वर का हो।',
      ...
      'printOptions': 'प्रिंट विकल्प',
      'viewPdf': 'PDF देखें',
      'bluetoothPrinter': 'ब्लूटूथ प्रिंटर',
      'connectingBluetooth': 'ब्लूटूथ कनेक्ट हो रहा है…',
      'noPairedBluetoothDevices': 'कोई पेयर किया हुआ ब्लूटूथ डिवाइस नहीं मिला',
      'selectPrinterDevice': 'प्रिंटर डिवाइस चुनें',
      'bluetoothConnectFailed': 'ब्लूटूथ प्रिंटर कनेक्शन विफल',
      'printingPleaseWait': 'प्रिंट हो रहा है… कृपया प्रतीक्षा करें',
      'printedSuccessfully': 'सफलतापूर्वक प्रिंट हुआ',
      'printFailed': 'प्रिंट विफल',
      'noPdfViewerInstalled': 'कोई PDF व्यूअर ऐप इंस्टॉल नहीं है',
      'connectBluetoothPrinter': 'ब्लूटूथ प्रिंटर कनेक्ट करें',
      'printChallan': 'चालान प्रिंट करें',
      'pleaseGrantBluetoothPermissions': 'कृपया ब्लूटूथ अनुमति दें',
      'pleaseTurnOnBluetooth': 'कृपया ब्लूटूथ चालू करें',
      'bluetoothPrinterConnected': 'ब्लूटूथ प्रिंटर कनेक्ट हो गया',
      'connectPrinterFirst': 'पहले ब्लूटूथ प्रिंटर कनेक्ट करें',
      ...
      'dataSyncSuccessfully': 'डेटा सफलतापूर्वक सिंक हो गया!',
      'syncedItemsCount': 'सिंक किए गए {synced} / {total} आइटम',
      'notSynced': 'सिंक नहीं हुए ({count}):',
      ...
      'selectFromError': 'कृपया से स्थान चुनें',
      'selectToError': 'कृपया तक स्थान चुनें',
    ...
    'ar': {
      ...
      'exhibition': 'المعرض',
      'noCountersFound': 'لا توجد عدادات متاحة',
      'noBoxesFound': 'لا توجد صناديق متاحة',
      'noBranchesFound': 'لا توجد فروع متاحة',
      'noExhibitionsFound': 'لا توجد معارض متاحة',
      'counter': 'العداد',
      'branch': 'الفرع',
      'search': 'بحث',
      'order': 'الطلب',
      ...
      'configureCustomApi': 'تكوين API مخصص',
      'enterApiUrl': 'أدخل رابط API',
      'apiUrlAuthorizedMessage': 'تأكد أن رابط API يخص خادم RRGOLD المعتمد.',
      ...
      'connectingBluetooth': 'جارٍ الاتصال بالبلوتوث…',
      'noPairedBluetoothDevices': 'لم يتم العثور على أجهزة بلوتوث مقترنة',
      'selectPrinterDevice': 'اختر جهاز الطابعة',
      'bluetoothConnectFailed': 'فشل الاتصال بطابعة البلوتوث',
      'printingPleaseWait': 'جارٍ الطباعة… يرجى الانتظار',
      'printedSuccessfully': 'تمت الطباعة بنجاح',
      'printFailed': 'فشلت الطباعة',
      'noPdfViewerInstalled': 'لا يوجد تطبيق لعرض PDF',
      'connectBluetoothPrinter': 'الاتصال بطابعة البلوتوث',
      'printChallan': 'طباعة الإيصال',
      'pleaseGrantBluetoothPermissions': 'يرجى منح أذونات البلوتوث',
      'pleaseTurnOnBluetooth': 'يرجى تشغيل البلوتوث',
      'bluetoothPrinterConnected': 'تم الاتصال بطابعة البلوتوث',
      'connectPrinterFirst': 'قم بتوصيل طابعة البلوتوث أولاً',
      ...
      'syncedItemsCount': 'تمت مزامنة {synced} / {total} عنصر',
      'notSynced': 'غير متزامن ({count}):',
      ...
      'selectFromError': 'يرجى اختيار الموقع المرسل منه',
      'selectToError': 'يرجى اختيار الموقع المرسل إليه',
